...
public class HelpCommand extends WolfPoundCommand {
    ...
    public HelpCommand(WolfPound plugin) {
        super(plugin);
        this.setName("Get Help with WolfPound");
        this.setCommandUsage("/wp " + ChatColor.GOLD + "[FILTER] [PAGE #]");
        this.setArgRange(0, 2);
        this.addKey("wp");
        this.addKey("wph");
        this.addKey("wphelp");
        this.addKey("wp help");
        this.addKey("wpsearch");
        this.addKey("wp search");
        this.setPermission("wolfpound.help", "Displays a nice help menu.", PermissionDefault.TRUE);
    }

    @Override
    public void runCommand(CommandSender sender, List<String> args) {
        sender.sendMessage(ChatColor.AQUA + "====[ WolfPound Help ]====");
